...
public class SnakeGameView extends Frame{
    ...
    public SnakeGameView(){
        random=new Random();
        //初始化Snake
        snake=new Snake(10*DrawView.VIEW_NUMBER
        +random.nextInt(15)*DrawView.VIEW_NUMBER,
                10*DrawView.VIEW_NUMBER+random.nextInt(15)*DrawView.VIEW_NUMBER,this);
        //初始化Egg
        ...
        jl=new JLabel("SnakeGame-NDKYJSJ",JLabel.CENTER);
        panel=new Panel();
    ...
    public void showView(){
        ...
        drawView.setBounds(20, 50, DrawView.VIEW_WIDTH * DrawView.VIEW_NUMBER + 1,
                DrawView.VIEW_HEIGHT * DrawView.VIEW_NUMBER + 1);
        panel.setLayout(null);
        panel.setBackground(new Color(0,102,102));
        panel.setBounds(DrawView.VIEW_WIDTH * DrawView.VIEW_NUMBER + 40, 50, 150,
                DrawView.VIEW_HEIGHT * DrawView.VIEW_NUMBER);
        ...
        panel.add(hint);
        this.add(jl);
        this.setTitle("SnakeGame1.0-NDKYJSJ");
